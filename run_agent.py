        ...
        def _run_review():
            ...
            try:
                with open(os.devnull, "w", encoding="utf-8") as _devnull, \
                    ...
                    # credentials keep working.  If the inherited runtime is the
                    # Codex app-server loop, downgrade the review fork to direct
                    # codex_responses so Hermes still owns tool dispatch for
                    # memory/skill_manage calls.
                    ...
                    review_agent = AIAgent(
                        ...
                        max_iterations=_review_runtime.get("max_iterations") or 16,
                        quiet_mode=True,
